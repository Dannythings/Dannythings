...
void setup();{
 ...
 //had to use 16 bit timer1 for this bc 1999>255, but could switch to timer 0 or 2 with larger prescaler
 // turn on CTC mode
...
if(Mode=6  && Second==0){Second=G3_time; Mode=7;  Open(Mode);}
